defmodule PhillyBandsWeb.Router do
  ...
  import PhillyBandsWeb.UserAuth
  ...
  scope "/", PhillyBandsWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{PhillyBandsWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", PhillyBandsWeb do
    ...
    live_session :current_user,
      on_mount: [{PhillyBandsWeb.UserAuth, :mount_current_user}] do
