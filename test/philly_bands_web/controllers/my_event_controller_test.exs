defmodule PhillyBandsWeb.MyEventControllerTest do
  ...
  describe "grouping" do
    test "groups events by month", %{conn: conn} do
      ...
      event1 = event_fixture(external_artist: "Artist A", date: ~N[2026-03-09 20:00:00])
      event2 = event_fixture(external_artist: "Artist B", date: ~N[2026-04-10 20:00:00])
